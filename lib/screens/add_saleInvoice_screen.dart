...
class _AddSaleInvoiceScreenState extends State<AddSaleInvoiceScreen> with SettingsReactive<AddSaleInvoiceScreen> {
  ...
  Future<void> _saveInvoice() async {
    ...
    try {
      ...
      if (result['success'] == true) {
        _showSuccess('✅ تم إنشاء الفاتورة رقم ${_invoiceNumberController.text}');
